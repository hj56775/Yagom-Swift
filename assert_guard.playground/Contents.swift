...
// 애플리케이션이 동작 도중에 생성하는 다양한 결과값을 동적으로 확인하고 완전하게 처리할 수 있도록 확인하고 빠르게 처리할 수 있습니다

import Swift

//MARK: - Assertion
// asser(_:_:file:line:) 함수를 사용합니다
...
//assert(someInt == 0, "someInt != 0") //Assertion failed: someInt != 0
...
func functionWithGuard(age : Int?){
    ...
    print("당신으 나이는 \(unwrappedAge)세입니다")
}
