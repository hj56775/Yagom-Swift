...
// 스위프트의 타입케스팅은 인스턴스의 타입을 확인하는 용도
...
//var jina : UniversityStudent = Person() as UniversityStudent // 부모를 자식으로는 컴파일 오류
var jina : Any = Person() // as Any 셍략가능
...
doSomethingWithSwitch(someone: jenny as Person)
